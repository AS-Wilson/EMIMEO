...
lifetime=s:solverstart
result=s:1
treepath=s:Farfields\farfield (f=1.5) [1]\farfield (f=1.5) [1]
files=s:farfield (f=1.5) [1].sig
...
lifetime=s:rebuild
result=s:1
treepath=s:Farfields\Farfield Cuts\Excitation [1]\Theta=0\farfield (f=1.5)
files=s:Farfield_Cut_farfield (f=1.5)_Theta=0_[1]_0.sig
