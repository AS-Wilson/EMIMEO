% THE 1D QUANTUM WELL -- WAVE FUNCTION SOLUTIONS -- PROBABILITIES
...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[ScienceRed,thick] ({\L-0.1},\BaseE) -- ({\L+0.15},\BaseE) node[right=1] {\tiny $\left| \Psi_1(x) \right|^2$} {};
		\draw[ScienceOrange,thick] ({\L-0.1},{\BaseE*4}) -- ({\L+0.15},{\BaseE*4}) node[right=1] {\tiny $\left| \Psi_2(x) \right|^2$} {};
		\draw[ScienceGreen,thick] ({\L-0.1},{\BaseE*9}) -- ({\L+0.15},{\BaseE*9}) node[right=1] {\tiny $\left| \Psi_3(x) \right|^2$}{};
