...
%				\draw[help lines] (0,0) grid (11,11);
	...
	\subsection{A Quick Example}
		...
		\begin{align}
			...
			& \mathlarger{ E = \Planckconst \nu = \frac{\Planckconst c}{\lambda} = \frac{12.4 \times 10^3 eV \cdot \r{A}}{250 \times 10^{-9} m } \text{\hspace{5mm}\footnotesize Remember an Angstrom is $1 \times 10^{-10}$ metres}} \nonumber\\
			& \label{eqn:ex_1_energy_single_quant} \mathlarger{ \implies \text{1 Quanta } = 4.96 eV} \\
			& \text{Number of quanta in the beam} \nonumber\\
			& \label{eqn:intenisty_def} \mathlarger{ \text{\normalsize Intensity }= 2 \frac{w}{m^2} = 2 \frac{J}{s \times m^2} } \\
			& \mathlarger{ \therefore \text{\normalsize No. of Quanta /$m^2s$} = 2 \frac{J}{s \times m^2} \times \frac{1}{\Planckconst \nu} }
		\end{align}
