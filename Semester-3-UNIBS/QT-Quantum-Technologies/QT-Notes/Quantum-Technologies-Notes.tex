...
\section{Bohr’s Model of the Hydrogen Atom}
	...
	\subsection{Bohr’s Hypothesis}
		...
		\begin{align}
			...
			& \label{eqn:bohrs_hypthesis} \mathlarger{ \therefore L_{\Theta} = \frac{\Planckconst}{2 \pi} n = \pmb{\hbar} n 
		\end{align}
		
		\vspace{5mm}
		
		Thus, in quantum physics, the angular momentum is quantised and an integer multiple of Planck's reduced constant, $\pmb{\hbar}$. \linebreak
