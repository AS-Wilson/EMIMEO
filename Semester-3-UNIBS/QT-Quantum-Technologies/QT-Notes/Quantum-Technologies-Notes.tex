...
\section{Bohr’s Model of the Hydrogen Atom}
	...
	\subsection{Force Balance}
		...
		\begin{equation*}
			\text{\small Force, }F = \text{mass, }m \cdot \frac{\text{\small Instant. Radial Velocity, }V_R^2}{\text{\small radius, }r}
		\end{equation*}
		
		As the only attractive/repellent forces in play here must be electromotive, the centrifugal force must therefore be equal to the electromotive forces. Given our previous definitions regard E.M.F and angular momentum we can thus 
