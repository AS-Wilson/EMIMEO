...
%				\draw[help lines] (0,0) grid (11,11);
	...
	\subsection{A Quick Example}
		...
		\begin{align}
			...
			& \label{eqn:intenisty_def} \mathlarger{ \text{\footnotesize Intensity }= 2\ \frac{w}{m^2} = 2\ \frac{J}{s \times m^2} } \\
			& \mathlarger{ \therefore \ \text{\footnotesize   No. of Quanta /$m^2s$} = 2\ \frac{J}{s \times m^2} \times \frac{1}{\Planckconst \nu} }
		\end{align}
