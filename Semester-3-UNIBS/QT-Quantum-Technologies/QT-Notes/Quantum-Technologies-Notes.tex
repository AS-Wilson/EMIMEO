...
%				\draw[help lines] (0,0) grid (11,11);
	...
	\subsection{A Quick Example}
		...
		\begin{equation}
			\label{eqn:quantum_flux} \mathlarger{\text{Flux}, F = \frac{\text{no. of quanta}, n}{\text{area}, a \times \text{time}, t}}
		\end{equation}
		...
		\begin{align}
			...
			& \mathlarger{ E = \Planckconst \nu = \frac{\Planckconst c}{\lambda} = \frac{12.4 \times 10^3 eV \cdot \r{A}}{250 \times 10^{-9} m } \text{ \small Remember an Angstrom is } 1 \times 10^{-10} \text{\small metres}} \nonumber\\
			& \label{eqn:ex_1_energy_single_quant} \mathlarger{ \implies \text{1 Quanta } = 4.96 eV} \\
			& \text{Number of quanta in the beam} \nonumber\\
			& \label{eqn:intenisty_def} \mathlarger{ \text{Intensity }= 2 \frac{w}{m^2} = 2 \frac{J}{s \times m^2} } \\
			& \mathlarger{ \therefore \: \nu_{th} = \frac{\Phi}{\Planckconst} }
		\end{align}
