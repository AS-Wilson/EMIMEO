	...
	\subsection{Black Body Radiation}
		...
		\begin{figure}[!h]
			...
			\begin{tikzpicture}[scale=2,rotate=10]
			  ...
			  \shade[top color=black!60,b.5ottom color=black!80,shading angle=10] % background
			    (7:1) arc (7:355:1);
...
\section{Bohr’s Model of the Hydrogen Atom}
	...
	\subsection{Force Balance - The Bohr Radius}
		...
		$r$ above is usually termed $r_0$ and is known as the Bohr Radius, it is the inner most orbit radius an electron can have in a hydrogen atom. All other orbits are square integer multiples of this value, giving us $r_n = r_0 \cdot n^2$ as a way of calculating the other possible orbits. \linebreak
		This means that all electron orbit radius' are \textbf{quantised}, we will explore the implications of this discovery in the following subsections. \linebreak 
