...
%				\draw[help lines] (0,0) grid (11,11);
	...
	\subsection{A Quick Example}
		...
		\begin{align}
			...
			& \label{eqn:intenisty_def} \mathlarger{ \text{\footnotesize Intensity }= 2\ \frac{w}{m^2} = 2\ \frac{J}{m^2 \times s} } \\
			& \mathlarger{ \therefore \ \frac{N}{m^2s} = 2\ \frac{J}{m^2 \times s} \times \frac{1}{\Planckconst \nu} = 2\ \frac{J}{m^2 \times s} \times 4.96 \cdot 1.602 \times 10^{-19} J } \nonumber\\
			& \label{eqn:ex_1_quant_in_beam} \text{\footnotesize   No. of Quanta /$m^2s$} \approx 
		\end{align}
