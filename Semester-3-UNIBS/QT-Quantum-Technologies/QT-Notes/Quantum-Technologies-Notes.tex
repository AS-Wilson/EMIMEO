...
%				\draw[help lines] (0,0) grid (11,11);
	...
	\subsection{A Quick Example}
		...
		\begin{equation}
			\label{eqn:quantum_flux} \mathlarger{Flux, F = \frac{no. of quanta, n}{area, a \times time, t}}
		\end{equation}
	...
	\begin{align}
		...
		& \mathlarger{ E = \Planckconst \nu = \frac{\Planckconst c}{\lambda} = \frac{12.4 \times 10^3 eV \cdot \r{A}}{250 \times 10^{-9} m } \text{Remeber an Angstrom is } 1 \times 10^{-10} \text{ metres}} \nonumber\\
		& \mathlarger{ \implies \text{1 Quanta} = 4.96 eV} \nonumber\\
		& \mathlarger{ \implies \nu \geq \frac{\Phi}{\Planckconst} } \nonumber\\
		& \label{eqn:photoelectric_th} \mathlarger{ \therefore \: \nu_{th} = \frac{\Phi}{\Planckconst} }
	\end{align}
